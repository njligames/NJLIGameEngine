...
//            
//            if(pthread_create(&this->updateThread, NULL, &WorldSound::UpdateThread, this)) 
//            {	
...
//    void WorldSound::AddSound(const std::string & fileName, const std::string & name)
//    {
//        if (this->ExistSound(name))
//        {
