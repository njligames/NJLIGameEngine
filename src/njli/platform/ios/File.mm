...
//        if (error) {
//            SDL_LogError(SDL_LOG_CATEGORY_TEST, "%s", [[error localizedDescription] UTF8String]);
//            return 0;
//        }
//        return 1;
//    }
//    SDL_LogWarn(SDL_LOG_CATEGORY_TEST, "Unable to create directory: %s ", [filePath UTF8String]);
//    return 0;
//}
...
int CRUD_create(const char *filename, const void *buffer, unsigned long len)
{
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:filePath])
    {
        ...
        {
//            SDL_LogVerbose(SDL_LOG_CATEGORY_TEST, "Created File %s\n", [filePath UTF8String]);
            return 1;
        }
...
int CRUD_read(const char *filename, void **buffer, unsigned long *len)
{
    ...
    SDL_LogWarn(SDL_LOG_CATEGORY_TEST, "file does not exists %s", [filePath UTF8String]);
...
int CRUD_update(const char *filename, const void *buffer, unsigned long len)
{
    ...
    SDL_LogError(SDL_LOG_CATEGORY_TEST, "File %s doesn't exists", [filePath UTF8String]);
    return 0;
}
