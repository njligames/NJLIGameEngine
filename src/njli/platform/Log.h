...
#define DEBUG_LOG_PRINT_E(tag, fmt, ...)                                                      \
    ...
    #define SDL_assertCheck(condition, fmt, args...) \
        do {                   \
            ...
            {\
                SDL_LogError(SDL_LOG_CATEGORY_TEST, "Assert '%s': %s", string, "Failed");\
            }\
            else\
            {\
...
#define DEBUG_GL_ERROR_PRINT(op, fmt, ...)                                                                                                                                                                                                                                                                                                                                                               \
    do {                                                                                                                                                                                                                                                                                                                                                                                                 \
        for (int error = glGetError(); error; error = glGetError()) {                                                                                                                                                                                                                                                                                                                                    \
            SDL_LogError(SDL_LOG_CATEGORY_TEST, "after %s(" fmt ")", #op, __VA_ARGS__);                                                                                                                                                                                                                                                                                                                      \
            switch (error) {                                                                                                                                                                                                                                                                                                                                                                             \
            case GL_NO_ERROR:                                                                                                                                                                                                                                                                                                                                                                            \
                SDL_LogVerbose(SDL_LOG_CATEGORY_TEST, "GL_NO_ERROR - No error has been recorded. The value of this symbolic constant is guaranteed to be 0.");                                                                                                                                                                                                                                                 \
                break;                                                                                                                                                                                                                                                                                                                                                                                   \
            case GL_INVALID_ENUM:                                                                                                                                                                                                                                                                                                                                                                        \
                SDL_LogError(SDL_LOG_CATEGORY_TEST, "GL_INVALID_ENUM - An unacceptable value is specified for an enumerated argument. The offending command is ignored and has no other side effect than to set the error flag.");                                                                                                                                                                           \
                break;                                                                                                                                                                                                                                                                                                                                                                                   \
            case GL_INVALID_VALUE:                                                                                                                                                                                                                                                                                                                                                                       \
                SDL_LogError(SDL_LOG_CATEGORY_TEST, "GL_INVALID_VALUE - A numeric argument is out of range. The offending command is ignored and has no other side effect than to set the error flag.");                                                                                                                                                                                                     \
                break;                                                                                                                                                                                                                                                                                                                                                                                   \
            case GL_INVALID_OPERATION:                                                                                                                                                                                                                                                                                                                                                                   \
                SDL_LogError(SDL_LOG_CATEGORY_TEST, "GL_INVALID_OPERATION - The specified operation is not allowed in the current state. The offending command is ignored and has no other side effect than to set the error flag.");                                                                                                                                                                        \
                break;                                                                                                                                                                                                                                                                                                                                                                                   \
            ...
            case GL_OUT_OF_MEMORY:                                                                                                                                                                                                                                                                                                                                                                       \
                SDL_LogError(SDL_LOG_CATEGORY_TEST, "GL_OUT_OF_MEMORY - There is not enough memory left to execute the command. The state of the GL is undefined, except for the state of the error flags, after this error is recorded.");                                                                                                                                                                  \
                break;                                                                                                                                                                                                                                                                                                                                                                                   \
            default:                                                                                                                                                                                                                                                                                                                                                                                     \
