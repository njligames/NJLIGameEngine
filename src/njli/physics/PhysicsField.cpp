...
namespace njli
{
    ...
    s32 PhysicsField::getType()const
    {
        return PhysicsField::type();
    }
    ...
    {
        return (PhysicsField**)World::getInstance()->getWorldFactory()->createArray(PhysicsField::type(), size);
    }
    ...
    {
        return dynamic_cast<PhysicsField*>(World::getInstance()->getWorldFactory()->create(PhysicsField::type()));
    }
    ...
    PhysicsField *PhysicsField::create(const PhysicsFieldBuilder &builder)
    {
        ...
        return dynamic_cast<PhysicsField*>(World::getInstance()->getWorldFactory()->create(*b));
    }
    
    PhysicsField *PhysicsField::clone(const PhysicsField &object)
    {
        return dynamic_cast<PhysicsField*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    
    PhysicsField *PhysicsField::copy(const PhysicsField &object)
    {
        return dynamic_cast<PhysicsField*>(World::getInstance()->getWorldFactory()->clone(object, true));
    }
