...
namespace njli
{
    ...
    Skinner::Skinner(const AbstractBuilder &builder):
    AbstractFactoryObject(this)
    {
        
    }
    
    Skinner::Skinner(const Skinner &copy):
    AbstractFactoryObject(this)
    {
    ...
    const char *Skinner::getClassName()const
    {
        return "Skinner";
    }
    
    s32 Skinner::getType()const
    {
        return Skinner::type();
    }
    ...
    {
        return (Skinner**)World::getInstance()->getWorldFactory()->createArray(Skinner::type(), size);
    }
    ...
    {
        return dynamic_cast<Skinner*>(World::getInstance()->getWorldFactory()->create(Skinner::type()));
    }
    ...
    Skinner *Skinner::create(const SkinnerBuilder &builder)
    {
        ...
        return dynamic_cast<Skinner*>(World::getInstance()->getWorldFactory()->create(*b));
    }
    
    Skinner *Skinner::clone(const Skinner &object)
    {
        return dynamic_cast<Skinner*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    
    Skinner *Skinner::copy(const Skinner &object)
    {
        return dynamic_cast<Skinner*>(World::getInstance()->getWorldFactory()->clone(object, true));
    }
