...
EMSCRIPTEN_BINDINGS(njli) {
	...
	function("new_s8Array", &new_s8Array, allow_raw_pointers());
	function("delete_s8Array", &delete_s8Array);
	function("s8Array_getitem", &s8Array_getitem);
	function("s8Array_setitem", &s8Array_setitem);
	function("new_u8Array", &new_u8Array, allow_raw_pointers());
	function("delete_u8Array", &delete_u8Array);
	function("u8Array_getitem", &u8Array_getitem);
	function("u8Array_setitem", &u8Array_setitem);
	function("new_s16Array", &new_s16Array, allow_raw_pointers());
	function("delete_s16Array", &delete_s16Array);
	function("s16Array_getitem", &s16Array_getitem);
	function("s16Array_setitem", &s16Array_setitem);
	function("new_u16Array", &new_u16Array, allow_raw_pointers());
	function("delete_u16Array", &delete_u16Array);
	function("u16Array_getitem", &u16Array_getitem);
	function("u16Array_setitem", &u16Array_setitem);
	function("new_s32Array", &new_s32Array, allow_raw_pointers());
	function("delete_s32Array", &delete_s32Array);
	function("s32Array_getitem", &s32Array_getitem);
	function("s32Array_setitem", &s32Array_setitem);
	function("new_u32Array", &new_u32Array, allow_raw_pointers());
	function("delete_u32Array", &delete_u32Array);
	function("u32Array_getitem", &u32Array_getitem);
	function("u32Array_setitem", &u32Array_setitem);
	function("new_s64Array", &new_s64Array, allow_raw_pointers());
	function("delete_s64Array", &delete_s64Array);
	function("s64Array_getitem", &s64Array_getitem);
	function("s64Array_setitem", &s64Array_setitem);
	function("new_u64Array", &new_u64Array, allow_raw_pointers());
	function("delete_u64Array", &delete_u64Array);
	function("u64Array_getitem", &u64Array_getitem);
	function("u64Array_setitem", &u64Array_setitem);
	function("new_f32Array", &new_f32Array, allow_raw_pointers());
	function("delete_f32Array", &delete_f32Array);
	function("f32Array_getitem", &f32Array_getitem);
	function("f32Array_setitem", &f32Array_setitem);
	function("new_f64Array", &new_f64Array, allow_raw_pointers());
	function("delete_f64Array", &delete_f64Array);
	function("f64Array_getitem", &f64Array_getitem);
	function("f64Array_setitem", &f64Array_setitem);
