...
namespace njli
{
    ...
    SteeringBehaviorSeek &SteeringBehaviorSeek::operator=(const SteeringBehaviorSeek &rhs)
    {
        if(this != &rhs)
        {
    ...
    void SteeringBehaviorSeek::serialize(void* dataBuffer, btSerializer* serializer) const
    {
        //TODO: serialize
    }
    ...
    {
        return (SteeringBehaviorSeek**)World::getInstance()->getWorldFactory()->createArray(SteeringBehaviorSeek::type(), size);
    }
    
    void SteeringBehaviorSeek::destroyArray(SteeringBehaviorSeek **array, const u32 size)
    {
    ...
    {
        return dynamic_cast<SteeringBehaviorSeek*>(World::getInstance()->getWorldFactory()->create(SteeringBehaviorSeek::type()));
    }
    
    SteeringBehaviorSeek *SteeringBehaviorSeek::create(const SteeringBehaviorSeekBuilder &builder)
    {
        AbstractBuilder *b = (AbstractBuilder *)&builder;
        
        return dynamic_cast<SteeringBehaviorSeek*>(World::getInstance()->getWorldFactory()->create(*b));
    }
    
    SteeringBehaviorSeek *SteeringBehaviorSeek::clone(const SteeringBehaviorSeek &object)
    {
        return dynamic_cast<SteeringBehaviorSeek*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    
    SteeringBehaviorSeek *SteeringBehaviorSeek::copy(const SteeringBehaviorSeek &object)
    {
        return dynamic_cast<SteeringBehaviorSeek*>(World::getInstance()->getWorldFactory()->clone(object, true));
    }
    ...
    void SteeringBehaviorSeek::load(SteeringBehaviorSeek &object, lua_State *L, int index)
    {
