...
namespace njli
{
    ...
    SteeringBehaviorFlee &SteeringBehaviorFlee::operator=(const SteeringBehaviorFlee &rhs)
    {
        if(this != &rhs)
        {
    ...
    void SteeringBehaviorFlee::serialize(void* dataBuffer, btSerializer* serializer) const
    {
        //TODO: serialize
    }
    ...
    {
        return (SteeringBehaviorFlee**)World::getInstance()->getWorldFactory()->createArray(SteeringBehaviorFlee::type(), size);
    }
    
    void SteeringBehaviorFlee::destroyArray(SteeringBehaviorFlee **array, const u32 size)
    {
    ...
    {
        return dynamic_cast<SteeringBehaviorFlee*>(World::getInstance()->getWorldFactory()->create(SteeringBehaviorFlee::type()));
    }
    
    SteeringBehaviorFlee *SteeringBehaviorFlee::create(const SteeringBehaviorFleeBuilder &builder)
    {
        AbstractBuilder *b = (AbstractBuilder *)&builder;
        
        return dynamic_cast<SteeringBehaviorFlee*>(World::getInstance()->getWorldFactory()->create(*b));
    }
    
    SteeringBehaviorFlee *SteeringBehaviorFlee::clone(const SteeringBehaviorFlee &object)
    {
        return dynamic_cast<SteeringBehaviorFlee*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    
    SteeringBehaviorFlee *SteeringBehaviorFlee::copy(const SteeringBehaviorFlee &object)
    {
        return dynamic_cast<SteeringBehaviorFlee*>(World::getInstance()->getWorldFactory()->clone(object, true));
    }
    ...
    void SteeringBehaviorFlee::load(SteeringBehaviorFlee &object, lua_State *L, int index)
    {
