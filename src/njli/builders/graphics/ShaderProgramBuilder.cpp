...
namespace njli
{
    ...
    ShaderProgramBuilder &ShaderProgramBuilder::operator=(const ShaderProgramBuilder &rhs)
    {
        if (this != &rhs)
        {
    ...
    s32	ShaderProgramBuilder::calculateSerializeBufferSize() const
    {
        return 0;
    }
    
    void ShaderProgramBuilder::serialize(void* dataBuffer, btSerializer* serializer) const
    {
    ...
    {
        return (ShaderProgramBuilder**)World::getInstance()->getWorldFactory()->createArray(ShaderProgramBuilder::type(), size);
    }
    
    void ShaderProgramBuilder::destroyArray(ShaderProgramBuilder **array, const u32 size)
    {
    ...
    {
        return dynamic_cast<ShaderProgramBuilder*>(World::getInstance()->getWorldFactory()->create(ShaderProgramBuilder::type()));
    }
    
    ShaderProgramBuilder *ShaderProgramBuilder::clone(const ShaderProgramBuilder &object)
    {
        return dynamic_cast<ShaderProgramBuilder*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    ...
    void ShaderProgramBuilder::load(ShaderProgramBuilder &object, lua_State *L, int index)
    {
