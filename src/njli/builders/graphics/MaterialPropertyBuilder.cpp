...
namespace njli
{
    ...
    {
        return (MaterialPropertyBuilder**)World::getInstance()->getWorldFactory()->createArray(MaterialPropertyBuilder::type(), size);
    }
    
    void MaterialPropertyBuilder::destroyArray(MaterialPropertyBuilder **array, const u32 size)
    {
    ...
    {
        return dynamic_cast<MaterialPropertyBuilder*>(World::getInstance()->getWorldFactory()->create(MaterialPropertyBuilder::type()));
    }
    
    MaterialPropertyBuilder *MaterialPropertyBuilder::clone(const MaterialPropertyBuilder &object)
    {
        return dynamic_cast<MaterialPropertyBuilder*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    ...
    void MaterialPropertyBuilder::load(MaterialPropertyBuilder &object, lua_State *L, int index)
    {
