...
namespace njli
{
    ...
    s32 MaterialBuilder::getType()const
    {
        return MaterialBuilder::type();
    }
    ...
    {
        return (MaterialBuilder**)World::getInstance()->getWorldFactory()->createArray(MaterialBuilder::type(), size);
    }
    ...
    {
        return dynamic_cast<MaterialBuilder*>(World::getInstance()->getWorldFactory()->create(MaterialBuilder::type()));
    }
    
    MaterialBuilder *MaterialBuilder::clone(const MaterialBuilder &object)
    {
        return dynamic_cast<MaterialBuilder*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
