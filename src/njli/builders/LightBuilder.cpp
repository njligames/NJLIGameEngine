...
namespace njli
{
    ...
    s32 LightBuilder::getType()const
    {
        return LightBuilder::type();
    }
    ...
    {
        return (LightBuilder**)World::getInstance()->getWorldFactory()->createArray(LightBuilder::type(), size);
    }
    ...
    {
        return dynamic_cast<LightBuilder*>(World::getInstance()->getWorldFactory()->create(LightBuilder::type()));
    }
    
    LightBuilder *LightBuilder::clone(const LightBuilder &object)
    {
        return dynamic_cast<LightBuilder*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
