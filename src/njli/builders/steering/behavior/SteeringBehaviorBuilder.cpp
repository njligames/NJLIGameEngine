...
namespace njli
{
    ...
    SteeringBehaviorBuilder::SteeringBehaviorBuilder(const SteeringBehaviorBuilder &copy)
    {
    ...
    SteeringBehaviorBuilder &SteeringBehaviorBuilder::operator=(const SteeringBehaviorBuilder &rhs)
    {
        if (this != &rhs)
        {
    ...
    void SteeringBehaviorBuilder::serialize(void* dataBuffer, btSerializer* serializer) const
    {
    ...
    {
        return (SteeringBehaviorBuilder**)World::getInstance()->getWorldFactory()->createArray(SteeringBehaviorBuilder::type(), size);
    }
    
    void SteeringBehaviorBuilder::destroyArray(SteeringBehaviorBuilder **array, const u32 size)
    {
    ...
    {
        return dynamic_cast<SteeringBehaviorBuilder*>(World::getInstance()->getWorldFactory()->create(SteeringBehaviorBuilder::type()));
    }
    
    SteeringBehaviorBuilder *SteeringBehaviorBuilder::clone(const SteeringBehaviorBuilder &object)
    {
        return dynamic_cast<SteeringBehaviorBuilder*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    ...
    void SteeringBehaviorBuilder::load(SteeringBehaviorBuilder &object, lua_State *L, int index)
    {
