...
namespace njli
{
    ...
    s32 CameraBuilder::getType()const
    {
        return CameraBuilder::type();
    }
    ...
    {
        return (CameraBuilder**)World::getInstance()->getWorldFactory()->createArray(CameraBuilder::type(), size);
    }
    ...
    {
        return dynamic_cast<CameraBuilder*>(World::getInstance()->getWorldFactory()->create(CameraBuilder::type()));
    }
    
    CameraBuilder *CameraBuilder::clone(const CameraBuilder &object)
    {
        return dynamic_cast<CameraBuilder*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
