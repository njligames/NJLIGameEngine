...
namespace njli
{
    ...
    PhysicsBodyRigidBuilder::PhysicsBodyRigidBuilder(const PhysicsBodyRigidBuilder &copy)
    {
    ...
    PhysicsBodyRigidBuilder &PhysicsBodyRigidBuilder::operator=(const PhysicsBodyRigidBuilder &rhs)
    {
        if (this != &rhs)
        {
    ...
    void PhysicsBodyRigidBuilder::serialize(void* dataBuffer, btSerializer* serializer) const
    {
    ...
    {
        return (PhysicsBodyRigidBuilder**)World::getInstance()->getWorldFactory()->createArray(PhysicsBodyRigidBuilder::type(), size);
    }
    
    void PhysicsBodyRigidBuilder::destroyArray(PhysicsBodyRigidBuilder **array, const u32 size)
    {
    ...
    {
        return dynamic_cast<PhysicsBodyRigidBuilder*>(World::getInstance()->getWorldFactory()->create(PhysicsBodyRigidBuilder::type()));
    }
    
    PhysicsBodyRigidBuilder *PhysicsBodyRigidBuilder::clone(const PhysicsBodyRigidBuilder &object)
    {
        return dynamic_cast<PhysicsBodyRigidBuilder*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    ...
    void PhysicsBodyRigidBuilder::load(PhysicsBodyRigidBuilder &object, lua_State *L, int index)
    {
