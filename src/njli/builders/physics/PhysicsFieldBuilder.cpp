...
namespace njli
{
    ...
    {
        return (PhysicsFieldBuilder**)World::getInstance()->getWorldFactory()->createArray(PhysicsFieldBuilder::type(), size);
    }
    
    void PhysicsFieldBuilder::destroyArray(PhysicsFieldBuilder **array, const u32 size)
    {
    ...
    {
        return dynamic_cast<PhysicsFieldBuilder*>(World::getInstance()->getWorldFactory()->create(PhysicsFieldBuilder::type()));
    }
    
    PhysicsFieldBuilder *PhysicsFieldBuilder::clone(const PhysicsFieldBuilder &object)
    {
        return dynamic_cast<PhysicsFieldBuilder*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    ...
    void PhysicsFieldBuilder::load(PhysicsFieldBuilder &object, lua_State *L, int index)
    {
