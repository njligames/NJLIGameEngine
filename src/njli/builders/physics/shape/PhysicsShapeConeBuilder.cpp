...
namespace njli
{
    ...
    PhysicsShapeConeBuilder::PhysicsShapeConeBuilder(const PhysicsShapeConeBuilder &copy)
    {
    ...
    PhysicsShapeConeBuilder &PhysicsShapeConeBuilder::operator=(const PhysicsShapeConeBuilder &rhs)
    {
        if (this != &rhs)
        {
    ...
    void PhysicsShapeConeBuilder::serialize(void* dataBuffer, btSerializer* serializer) const
    {
    ...
    {
        return (PhysicsShapeConeBuilder**)World::getInstance()->getWorldFactory()->createArray(PhysicsShapeConeBuilder::type(), size);
    }
    
    void PhysicsShapeConeBuilder::destroyArray(PhysicsShapeConeBuilder **array, const u32 size)
    {
    ...
    {
        return dynamic_cast<PhysicsShapeConeBuilder*>(World::getInstance()->getWorldFactory()->create(PhysicsShapeConeBuilder::type()));
    }
    
    PhysicsShapeConeBuilder *PhysicsShapeConeBuilder::clone(const PhysicsShapeConeBuilder &object)
    {
        return dynamic_cast<PhysicsShapeConeBuilder*>(World::getInstance()->getWorldFactory()->clone(object, false));
    }
    ...
    void PhysicsShapeConeBuilder::load(PhysicsShapeConeBuilder &object, lua_State *L, int index)
    {
